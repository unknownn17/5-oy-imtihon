...
type Hotel interface{
	...
	Gets(ctx context.Context,req *models.GetsRequest)([]*models.UpdateRoomRequest,error)
	...
	GetRoom(ctx context.Context,req *models.GetRoomRequest)(*models.UpdateRoomRequest)
	GetRooms(ctx context.Context,req *models.GetsRequest)([]*models.GetRoomResponse)
...
type Adjust interface{
	...
	GetRoom(ctx context.Context,req *hotel.GetroomRequest)(*hotel.UpdateRoomRequest)
	GetRooms(ctx context.Context,req *hotel.GetsRequest)(*hotel.GetroomResponse,error)
