...
func (u *Database) Create(ctx context.Context, req *models.BookHotelRequest, price float64) (*models.GeneralResponse, error) {
	...
	return &models.GeneralResponse{Message: fmt.Sprintf("Booking is created with this id %v", id)}, nil
}
...
func (u *Database) Update(ctx context.Context, req *models.BookHotelUpdateRequest) (*models.GeneralResponse, error) {
	...
	return &models.GeneralResponse{Message: fmt.Sprintf("Booking is updated with this id %v", id)}, nil
}
...
func (u *Database) Cancel(ctx context.Context, req *models.CancelRoomRequest) (*models.GeneralResponse, error) {
	...
	return &models.GeneralResponse{Message: fmt.Sprintf("Booking is deleted with this id %v", req.ID)}, nil
}
...
func (u *Database) CreateW(ctx context.Context, req *models.CreateWaitingList) (*models.GeneralResponse, error) {
	...
	return &models.GeneralResponse{Message: fmt.Sprintf("User has been added to waiting list with this id %v", id)}, nil
}
...
func (u *Database) UpdateW(ctx context.Context, req *models.UpdateWaitingListRequest) (*models.GeneralResponse, error) {
	...
	return &models.GeneralResponse{Message: fmt.Sprintf("Waiting List  is updated with this id %v", id)}, nil
}
...
func (u *Database) DeleteW(ctx context.Context, req *models.DeleteWaitingList) (*models.GeneralResponse, error) {
	...
	return &models.GeneralResponse{Message: fmt.Sprintf("waiting List  is deleted  this id %v", req.ID)}, nil
}
